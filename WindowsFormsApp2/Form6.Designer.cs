namespace WindowsFormsApp2
{
    ...
    "юта клиента\".";
            ...
            this.label3.Text = "Над таблицами находится интерфейс  с которым можно редактировать , добавлять и та" +
    "кже удалять данные с таблиц";
            // 
            // button1
            // 
            ...
            this.ClientSize = new System.Drawing.Size(627, 133);
